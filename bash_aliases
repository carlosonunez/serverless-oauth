...
# commands available to you while testing the My_First_Project API.
...
alias integration_test="docker-compose up -d selenium && docker-compose run --rm -e DISABLE_MY_FIRST_PROJECT_CALLBACK_UPDATING=true integration && docker-compose down"
